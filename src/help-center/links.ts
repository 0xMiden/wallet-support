...
export interface HelpCenterSocial {
  readonly id: string;
  readonly label: string;
  readonly href: string;
  /** The brand's own mark, drawn as a filled path on a 24x24 viewBox. */
  readonly path: string;
}

/**
 * The project's accounts, as given. Brand marks rather than initials, because
 * a row of letters in the footer is not recognisable at 20px.
 */
export const helpCenterSocials: readonly HelpCenterSocial[] = [
  {
    id: 'x',
    label: 'X',
  ...
  },
  {
    id: 'github',
    label: 'GitHub',
    href: 'https://github.com/0xMiden/wallet',
